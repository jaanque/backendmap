...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-background)] font-sans selection:bg-black selection:text-white">
      ...
      {/* Hero Section */}
      <section className="border-b border-[var(--color-border)] relative overflow-hidden bg-white">
        <HeroBackground />

        <div className="container-pro py-24 md:py-40 grid md:grid-cols-2 gap-20 items-center relative z-10">
