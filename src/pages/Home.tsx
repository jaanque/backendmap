...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white  font-sans text-zinc-900  selection:bg-black  selection:text-white  transition-colors duration-300">
      <Navbar />
      ...
      <section className="px-4 md:px-12 max-w-5xl mx-auto mb-20 animate-fade-in-up">
        <div className="bg-zinc-50  rounded-2xl p-8 md:p-12 border border-zinc-100  transition-colors">
           <h2 className="text-2xl font-bold text-center mb-10 text-zinc-900 ">How BackendMap Works</h2>
           <div className="grid md:grid-cols-3 gap-8">
              <div className="flex flex-col items-center text-center">
                 <div className="w-12 h-12 bg-white  rounded-xl shadow-sm border border-zinc-200  flex items-center justify-center text-indigo-600  mb-4 transition-colors">
                    <BookOpen size={24} />
                 </div>
                 <h3 className="font-bold text-lg mb-2 text-zinc-900 ">1. Choose a Scenario</h3>
              ...
              <div className="flex flex-col items-center text-center">
                 ...
                 <h3 className="font-bold text-lg mb-2 text-zinc-900 ">2. Watch the Flow</h3>
                 <p className="text-zinc-500  text-sm leading-relaxed">
              ...
              <div className="flex flex-col items-center text-center">
                 ...
                 <h3 className="font-bold text-lg mb-2 text-zinc-900 ">3. Master & Share</h3>
                 <p className="text-zinc-500  text-sm leading-relaxed">
