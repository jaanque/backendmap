...
export default function Navbar() {
  ...
  return (
    <nav className="border-b border-zinc-100  h-16 flex items-center justify-between px-6 md:px-12 sticky top-0 bg-white/90  backdrop-blur z-50 transition-colors duration-300" aria-label="Main Navigation">
          ...
          <div className="flex items-center gap-4">
            <div className="relative" ref={createDropdownRef}>
              <button
                ...
                className="hidden md:flex items-center gap-2 px-3 py-1.5 text-xs font-semibold text-zinc-600  hover:text-black  transition-colors focus:outline-none"
              >
                <PlusSquare size={18} />
                <span>Create</span>
              </button>
              ...
              {isCreateDropdownOpen && (
                <div
                  className="absolute right-0 mt-2 w-48 bg-white  border border-zinc-200  rounded-xl shadow-lg  py-1 z-50 animate-in fade-in zoom-in-95 duration-100 origin-top-right ring-1 ring-black/5"
                  role="menu"
                >
                  <Link
                    to="/create"
                  ...
                  <Link
                    ...
                    onClick={() => setIsCreateDropdownOpen(false)}
                  >
                    <div className="w-4 h-4 rounded border-2 border-zinc-400  flex items-center justify-center">
            ...
            >
               ...
               <span className="hidden lg:inline-block text-xs text-zinc-600  font-medium max-w-[150px] truncate group-hover:text-zinc-900 ">{displayName || user.email}</span>
            ...
            {isDropdownOpen && (
              ...
              >
                ...
                <div className="pb-1">
                  ...
                  <Link
                    to="/create"
                    className="md:hidden w-full text-left px-4 py-2 text-sm text-zinc-700  hover:bg-zinc-50  flex items-center gap-3 transition-colors"
                    onClick={() => setIsDropdownOpen(false)}
                  >
                    <PlusSquare size={16} className="text-zinc-400 " />
                    Create Scenario
